\chapter[Coordinates, vectors, and matrices]{Coordinates, column vectors, and matrices}
\chaptermark{Coordinates, column vectors, and matrices}
...
\begin{dfn}{Coordinates (of a vector)}{CoordinatesVector}
	...
	\end{equation}
	for unique $v^b\in \K$.  Then, the \term{coordinates}\index{Coordinates (of a vector)} of $v$ with respect to the basis $\basis{B}$, $\coordinates{v}{\basis{B}}$\index[notation]{$\coordinates{v}{\basis{B}}$}, are defined by
	\begin{equation}
...
\section[Coordinates, lin.-trans., and matrices]{Coordinates, linear-transformations, and matrices}
\sectionmark{Coordinates, linear-transformations, and matrices}
