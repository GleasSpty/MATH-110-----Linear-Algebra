...
\begin{dfn}{Weakly algebraically-closed}{WeaklyAlgebraicallyClosed}
	Let $\K$ be a ring.  Then, $\K$ is \term{right (resp.~left, resp.~two-sided) weakly algebraically-closed}\index{Weakly algebraically-closed} iff every nonconstant $p\in \K [x]$ has a right (resp.~left, resp.~two-sided) in $\K$.
	\begin{rmk}
	...
	\end{rmk}
\end{dfn}
\begin{dfn}{Weakly integrally-closed}{WeaklyIntegrallyClosed}
	Let $\K$ be a ring.  Then, $\K$ is \term{right (resp.~left, resp.~two-sided) integrally-closed}\index{Weakly integrally-closed} iff every nonconstant monic $p\in \K [x]$ has a right (resp.~left, resp.~two-sided) root in $\K$.
	\begin{rmk}
...
\begin{dfn}{Algebraic $\K$-algebra}{AlgebraicKAlgebra}
	...
	\end{rmk}
\end{dfn}
\begin{dfn}{Integral $\K$-algebra}{IntegralKAlgebra}
