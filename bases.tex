\chapter[Lin.-ind., span, bases, and dimension]{Linear-independen\-ce, spanning, bases, and dimension}\label{chpBases}
\chaptermark{Lin.-ind., spanning, bases, and dimension}
...
\begin{dfn}{Cofinite}{Cofinite}
	Let $X$ be a set and let $S\subseteq X$.  Then, $S$ is \term{cofinite}\index{Cofinite} in $X$ iff $X\setminus S$ is finite.
\end{dfn}
