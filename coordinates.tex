...
\begin{bmatrix}3 & 0 & -5 & 2 \\ -4 & 2 & 3 & -1\end{bmatrix}.
\end{equation}
...
\end{equation}
If we every need to distinguish between the two, the matrix in \eqref{eqn1.1.101} will be referred to as the \term{augmented matrix}\index{Augmented matrix} associated to the system.
...
\begin{bmatrix}1 & 0 & 5 & 2 & 0 & -7 \\ 0 & 1 & -4 & 3 & 0 & 5 \\ 0 & 0 & 0 & 0 & 1 & 5\end{bmatrix},
\end{equation}
whence we see that its solution set is described by
\begin{equation}
